...
<a href="/bicikle/public/rezervacije" class="btn btn-default"> Vrati se nazad</a>
<h1> Podaci nosioca rezervacije: {{$rez->ime}} {{$rez->prezime}}</h1>
    <div>
        Datum preuzimanja bicikle:{{$rez->datum_preuzimanja}}
    </div>
    <div>
    ...
    <div>
        Bicikla: {{$rez->bicikla_id}}
    </div>
    <div>
        Korisnik: {{$rez->user_id}}
     </div>
    <a href="/bicikle/public/rezervacije/{{$rez->id}}/edit" class="btn btn-defualt">Izmeni</a>
